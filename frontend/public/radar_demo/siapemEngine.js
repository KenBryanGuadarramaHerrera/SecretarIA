...
export function programasCDMX({ figura = 'fisica', giro = 'comercio', tamano = 'micro', perfil = [] } = {}) {
  ...
  P.push({
    ...
    url: 'https://www.fondeso.cdmx.gob.mx/programas'
  });
  ...
  P.push({
    ...
    aplica: true,
    url: 'https://www.sedeco.cdmx.gob.mx/actividades/capacitacion'
  });
  ...
  P.push({
    ...
    url: 'https://ciudadsolar.cdmx.gob.mx/'
  });
